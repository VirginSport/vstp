            ...
            <div class="row">
              ...
              <form @submit.prevent class="vs-user-profile-form vs-user-profile-form--body" v-bind:class="{ 'vs-user-profile-form--edit': edit_mode }" novalidate>
                ...
                <div class="row">
                  <div class="col-xs-12 col-md-8 offset-md-2">
                    <div class="row">
                      <div class="col-xs-12 col-md-6">
                        ...
                        <div class="field-athletics-number vs-form-group">
                          ...
                          <input class="form-control" v-show="edit_mode" type="text" v-model="profile.field_uk_athletics_number" name="field_uk_athletics_number">
                    ...
                    <div class="field-medications vs-form-group">
                      ...
                      <textarea class="form-control vs-textarea" v-show="edit_mode" v-model="profile.field_medications" name="field_medications"></textarea>
                    ...
                    <div class="field-allergies vs-form-group">
                      ...
                      <textarea class="form-control vs-textarea" v-show="edit_mode" v-model="profile.field_allergies" name="field_allergies"></textarea>
                    ...
                    <div class="field-marketing vs-form-group vs-form-group--checkboxes">
                      ...
                      <div class="col-xs-12 text-md-right">
                        <div class="vs-form-group--buttons">
                          ...
                          <button class="btn vs-btn vs-btn--min-sm" :disabled="!$vs_user_profile_validator.valid" v-show="edit_mode" v-on:click="submit"><?php print ('Confirm Changes'); ?></button>
                          <button class="btn vs-btn vs-btn--outline-black" v-show="edit_mode" v-on:click="cancel('edit_mode')"><?php print ('Cancel Changes'); ?></button>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xs-12">
                    <div class="vs-form-group--buttons">
                      <button class="btn vs-btn vs-btn--outline-black" :disabled="edit_mode" v-show="!password_mode" v-on:click="edit('password_mode')"><?php print ('Edit Password'); ?></button>
                      ...
                      <button class="btn vs-btn vs-btn--outline-black" :disabled="!$vs_user_password_validator.valid" v-show="password_mode" v-on:click="submit"><?php print ('Confirm Changes'); ?></button>
                    </div>
                  </div>
                </div>
                </validator>
