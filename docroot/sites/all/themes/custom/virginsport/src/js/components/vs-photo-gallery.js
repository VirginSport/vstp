...
function initPhotoGalleries() {
  var $photoGalleries = $(".vs-photo-gallery:not(.photo-gallery-initialized), .vs-photo-gallery:not(.photo-gallery-initialized)");
  ...
  $photoGalleries.each(function (i, obj) {
    ...
    $fsImageWrapper.find(".slick-current").keyup(function (e) {
      if (e.keyCode == 27) {
        modal.close();
