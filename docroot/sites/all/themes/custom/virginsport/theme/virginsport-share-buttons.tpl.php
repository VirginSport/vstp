...
<div class="vs-share-button">
  <div class="vs-share-button__content">
    <div class="hidden-xs-down vs-share-button__social-links">
      ...
      <a class="vs-share-button__icon-button vs-share-button__icon-facebook" href="http://www.facebook.com/sharer.php?url=<?php print urlencode($url); ?>"><i class="icon-facebook"></i><span></span></a>
      <a class="vs-share-button__icon-button vs-share-button__icon-email" href="mailto:?subject=<?php print urlencode($subject); ?>&body=<?php print urlencode($url); ?>"><i class="icon-email-filled"></i><span></span></a>
    </div>
